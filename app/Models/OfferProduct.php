...
class OfferProduct extends Model
{
     ...
     */
    protected $fillable = [
        'productIdx', 'offerIdx', 'productType', 'productTitle', 'productMoreInfo', 'productAccessDays', 'productBidType', 'productPrice', 'productInstruction', 'productStatus', 'productLicenseUrl', 'uniqueProductIdx'
    ];    
