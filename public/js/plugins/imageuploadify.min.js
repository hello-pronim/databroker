    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let dragbox = $(`
              <div class="imageuploadify well">
                ...
                <div class="imageuploadify-images-list text-center">          
                  ...
                  <p>OR</p>
                  <button type="button" class="secondary-btn w225 mgh25">Select image from your device</button>
                </div>
            ...
            if (desc_txt !== '' && desc_txt !== undefined) {
                dragbox.find('.description').html('<a data-toggle="modal" data-target="#mediaLibraryModal" data-id="123123" data-type="offer">' + desc_txt + '</a>');
