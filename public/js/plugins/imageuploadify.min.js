    ...
    $.fn.imageuploadify = function(opts) {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">          
          <span class='imageuploadify-message'>Drag and drop files here</span>
          <p>OR</p>
          <button type="button" class="btn btn-round sendmessage-btn">Select A File</button>
        </div>
      ...
      `);
            ...
            const retrieveFiles = (files, name) => {
            ...
            const readingFile = (id, file) => {
                ...
                if (file.type && file.type.search(/image/) != -1) {
                    ...
                    // fReader.onloadend = function(e) {
                        ...
                        let span = $("<span>" + type + file.name + "</span>");
            ...
            if (input_count == false) {
                ...
                $(self).closest("form").on("submit", function(event) {
                    ...
                    for (var i = 0; i < totalFiles.length; i++) {                         	               	
                    	if( (i+1) < totalFiles.length ){
                    		if(totalFiles[i].name == totalFiles[i+1].name){
	                    		temp_total++;
	                    		formData.append(totalFiles[i].name+"_"+temp_total, totalFiles[i].file);	                    	
	                    	}else{
	                    		temp_total++;
								formData.append(totalFiles[i].name+"_"+temp_total, totalFiles[i].file);
								temp_total = 0;
