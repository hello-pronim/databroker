        ...
        var settings = {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <a href="/admin/home_trending/edit/`+data+`" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">
...
$("#upload_attach").change(function(event){
    ...
    $.ajax({
        ...
        url: "/admin/home_trending/upload_attach/" + attach_record_idx,
        type: 'POST',
        data: data,
        contentType: false,
        processData: false,
