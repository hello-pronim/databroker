    ...
    var initTableWithDynamicRows = function() {
        ...
        var settings = {
            ...
            columnDefs: [
                ...
                {
                    targets: -1,
                    title: 'Actions(Edit,Thumbnail,Logo)',
                    orderable: false,
                    render: function(data, type, full, meta) {
                        return `
                            <a href="/admin/home_marketplace/edit/`+data+`" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">
...
$("#upload_logo").change(function(event){
    ...
    $.ajax({
        ...
        url: "/admin/home_marketplace/upload_logo/" + attach_logo_idx,
        type: 'POST',
        data: data,
        contentType: false,
        processData: false,
...
$("#upload_attach").change(function(event){
    ...
    $.ajax({
        ...
        url: "/admin/home_marketplace/upload_attach/" + attach_record_idx,
        type: 'POST',
        data: data,
        contentType: false,
        processData: false,
