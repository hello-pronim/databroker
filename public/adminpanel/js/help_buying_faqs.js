            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <a href="/admin/help/buying_data/faq/edit/` + data + `" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">
  ...
  function(isConfirm) {
    if (isConfirm) {
      $.ajax({
        ...
        url: '/admin/help/buying_data/faq/delete/'+record_idx,
        method: 'get',
