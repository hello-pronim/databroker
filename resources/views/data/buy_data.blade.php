								...
								<div class="col-md-12">
		                            ...
		                            <div class="form-check">
		                                <label class="form-check-label">
		                                    ...
		                                    <p class="text-black fs-16 lh-24">{!! trans('data.accept_license_seller') !!}</p>
		                                    <span class="form-check-sign">
		                                        <span class="custom-check check"></span>
		                                    </span>
					...
					<div class="row">
						<div class="col-6 auth-section">
							<div>
								...
								<input type="hidden" name="userIdx" value="{{$buyer->userIdx}}">
								<input type="hidden" name="productPrice" value="{{$product->productPrice}}">
								<label class="pure-material-textfield-outlined">
			                        <input type="text" id="firstname" name="firstname" class="form-control input_data @error('firstname')  is-invalid @enderror" placeholder=" "  value="{{ old('firstname', $buyer->firstname) }}" autocomplete="firstname" autofocus readonly>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="lastname" name="lastname" class="form-control input_data @error('lastname')  is-invalid @enderror" placeholder=" "  value="{{ old('lastname', $buyer->lastname) }}" autocomplete="lastname" autofocus readonly>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="email" name="email" class="form-control input_data @error('email')  is-invalid @enderror" placeholder=" "  value="{{ old('email', $buyer->email) }}" autocomplete="email" autofocus readonly>
		                    ...
		                    <div class="mt-10">
								...
								<label class="pure-material-textfield-outlined">
			                        <input type="text" id="companyName" name="companyName" class="form-control input_data @error('companyName')  is-invalid @enderror" placeholder=" "  value="{{ old('companyName', $buyer->companyName) }}" autocomplete="companyName" autofocus readonly>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="companyVAT" name="companyVAT" class="form-control input_data @error('companyVAT')  is-invalid @enderror" placeholder=" "  value="{{ old('companyVAT', $buyer->companyVAT) }}" autocomplete="companyVAT" autofocus readonly>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="address" name="address" class="form-control input_data @error('address')  is-invalid @enderror" placeholder=" "  value="{{ old('address') }}" autocomplete="address" autofocus>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="city" name="city" class="form-control input_data @error('city')  is-invalid @enderror" placeholder=" "  value="{{ old('city', $buyer->city) }}" autocomplete="city" autofocus>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="postal_code" name="postal_code" class="form-control input_data @error('postal_code')  is-invalid @enderror" placeholder=" "  value="{{ old('postal_code') }}" autocomplete="postal_code" autofocus>
			                    ...
			                    <label class="pure-material-textfield-outlined">
			                        <input type="text" id="state" name="state" class="form-control input_data @error('state')  is-invalid @enderror" placeholder=" "  value="{{ old('state') }}" autocomplete="state" autofocus>
			                    ...
			                    <div class="dropdown-container">
			                        <div class="dropdown2 region_list" tabindex="1">                                
			                            <div class="adv-combo-wrapper">
			                            	@if($buyer->regionIdx)
			                            	<input type="hidden" name="regionIdx" value={{$buyer->regionIdx}}>
