    ...
    <div class="container mb-40">	
		<div class="row">
			<div class="col-lg-6">
				<div class="blog-header mt-60">
		            <h2 class="text-primary text-bold">Publishing your data offer</h2>		            
		        </div>		        
			</div>			
		</div>
		...
		<div class="row mt-30">
			<div class="col-lg-6 publish_start">				
				<div class="mt-20">
					<h4 class="text-bold"><span class="fs-30">1. </span> Basic information about your data offer (mandatory)</h4>
				...
				<div class="mt-20">
					<h4 class="text-bold"><span class="fs-30">2. </span> More details about your data (optional but recommended)</h4>
				...
				<div class="mt-20">
					<h4 class="text-bold"><span class="fs-30">4. </span> Examples (optional but recommended)</h4>
