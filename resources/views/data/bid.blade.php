	        		...
	        		<div class="col-md-6 auth-section">
	        			<form method="POST" action="{{route('data.send_bid', ['id'=>$product->offerIdx, 'pid'=>$product->productIdx])}}">
		        			...
		        			<label class="pure-material-textfield-outlined currency-input">
		                        ...
		                        <input type="number" id="bidPrice" step="0.01" placeholder="0.00" name="bidPrice" class="form-control input_data price_input @error('bidPrice') is-invalid @enderror" placeholder=" "  value="{{ old('bidPrice') }}" autofocus>
