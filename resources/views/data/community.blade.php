...
<div class="container-fluid app-wapper">	
    <div class="container">
	    ...
	    <div class="mt-40 text-center">		        	
        	<button type="button" class="btn btn-round sendmessage-btn">{{ trans('pages.view_dataoffer') }}</button>
        </div>
...
<div class="container-fluid app-wapper">	
	<div class="container">
		...
		<div class="row">
  		...
  		<div class="mt-40 text-center">		        	
        	<button type="button" class="btn btn-round sendmessage-btn">View Data Offer</button>
        </div>
    </div>    
</div>  
