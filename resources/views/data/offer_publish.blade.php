        	...
        	<div class="col-lg-6">
        		...
        		<div class="row">
        			@foreach ($communities as $community)
                        <div class="col-md-4 mt-10 text-bold fs-18"><a class="text-black" href="{{ route('data.'.str_replace( ' ', '_', strtolower($community->communityName))) }}">{{ $community->communityName }}</a></div>
                    @endforeach  
        		</div>
        	</div>
        	<div class="col-lg-6">
