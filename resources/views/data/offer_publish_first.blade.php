    ...
    <div class="container mb-40">	
		<div class="row">
			<div class="col-lg-6">
				<div class="blog-header mt-60">
		            <h2 class="text-primary text-bold">It looks like it’s the first time you’re publishing a data offer.</h2>
		        </div>		        
			</div>			
		</div>
		...
		<div class="row mt-30">
			<div class="col-lg-6 publish_start">				
				<div class="mt-20">
					<h4 class="text-bold"><span class="fs-30">1. </span> The data offer: A data offer is a high-level description of data you want to sell</h4>
				...
				<div class="mt-20">
					<h4 class="text-bold"><span class="fs-30">2. </span> The data products: You can add defined data products to a particular data offer at any time</h4>
				...
				<div class="mt-20">
					<h4 class="text-bold"><span class="fs-30">3. </span> The DXC</h4>
			...
			<div class="col-lg-4">				
				<div class="publish_box">
        			<h4 class="text-bold">More questions? </h4>        			
