				...
				<div class="col-6">
					...
					<div class="dropdown-container">
                        <div class="custom-dropdown" tabindex="1">
                            ...
                            <input type="hidden" id="region" name="region" value="Agriculture/Mining/Forestry">
                            <ul class="custom-dropdown-menu region-select" style="display: none;">
                            	<h4>{{ trans('pages.select_region') }}:</h4>
                               	<div class="check_container">
			                        <label class="pure-material-checkbox">
			                            <input type="checkbox" class="form-control no-block check_community" name="region[]" value="1" id="check_community_1">
			                            <span>World</span>
			                        </label>
			                    </div>
			                    <div class="check_container">
