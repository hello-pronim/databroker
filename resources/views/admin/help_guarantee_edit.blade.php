				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						<div class="col-md-12 m-form__group-sub">
							...
							<textarea class="form-control m-input summernote" rows="5" name="description" placeholder="Enter description">{{ isset($topic)? $topic->description : '' }}</textarea>
						</div>
					</div>
				</div>
					...
					<div class="m-form__actions m-form__actions">
						<div class="row">
							<div class="col-lg-9 ml-lg-auto">
								...
								<a href="{{ route('admin.help.guarantee') }}" class="btn btn-secondary">Cancel</a>
							</div>
						</div>
					</div>
				</div>
...
@section('additional_javascript')
    <script src="{{ asset('adminpanel/js/help_guarantee_add_new.js') }}"></script>        
@endsection
