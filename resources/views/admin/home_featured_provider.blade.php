                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="board_table">
                    ...
                    <tbody>
                        @foreach($boards as $board)                      
                            <tr>
                                <td align="center">
                                    <a href="{{ route('data.company_offers', ['companyName'=>str_replace(' ', '-', strtolower($board->companyName))]) }}">
                                ...
                                <td><a href="{{ route('data.company_offers', ['companyIdx'=>str_replace(' ', '-', strtolower($board->companyName))]) }}">{{$board->companyName}}</a></td>
                                <td>
