...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator"><b style="color: #9102f7;">CMS Help - Our guarantees</h3>
            </div>
        </div>
    </div>
    <!-- END: Subheader -->
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{ route('admin.help.add_guarantee') }}" class="btn btn-focus m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
                                    <span>
...
@section('additional_javascript')
    ...
    <script src="{{ asset('adminpanel/js/help_guarantees.js') }}"></script>            
@endsection
