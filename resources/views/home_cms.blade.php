				...
				<div class="card card-raised card-background" style="background-image: url({{ asset('uploads/home/featured_data/'.($featured_data->image??'')) }})">
					<div class="card-body">
						...
						<div class="card-author">
							...
							<a href="{{route('data.company_offers', ['companyName'=>str_replace(' ', '-', strtolower($featured_data->companyName))])}}"><img src="{{ asset('uploads/company/tiny/'.($featured_data->companyLogo??'')) }}"></a>
						</div>	
                        @endif					
					</div>
                </div>
