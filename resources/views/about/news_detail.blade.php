...
@section('title', 'Get inspired by real-life use cases for data | Databroker ')
@section('description', 'Curious how data can be turned into a true competitive advantage? Read our use cases to understand how sourcing the right kind of data can bring real value. ')
    ...
    <div class="container">
        <div class="app-section app-reveal-section align-items-center usecases detail">
            <div class="blog-header row">                
                <div class="col-md-12">
                    <h1 class="h1-small">{{$new['title']}}</h1>
                    <p class="fs-18"><b>Published in</b>:&nbsp; <a href="{{ route('data_community.'.strtolower($new['category'])) }}"><span class="h3" id="matchmaking-detail-category">{{ $new['category'] }}</span></a></p>
                </div>                
            </div>          
