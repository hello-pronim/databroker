        	...
        	<div class="navbar navbar-expand-lg">
        		<div class="container">        		
	    			<ul class="navbar-nav left">
		        		<li class="nav-item"><a class="nav-link" href="javascript:;">{{ trans('home.publish_data_offer') }}</a></li>
            ...
            <div class="app-section app-footer-section align-items-center">
                ...
                <div class="app-footer-social-link-container">
                    <div class="app-footer-social-link">
                        ...
                        <a href="https://twitter.com/DataBrokerDAO" target="_blank">
                          <i class="fa fa-twitter fa-3x"></i></a>
                        <!--a href="" target="_blank"><img src="{{ asset('images/pinterest.png') }}"></a-->
                        <a href="https://www.reddit.com/r/DatabrokerDAO/" rel="nofollow noopener noreferrer" target="_blank">
                          <i class="fa fa-reddit fa-3x"></i>
                        </a>
                        <a href="https://medium.com/databrokerdao" class="rectangle_link" rel="nofollow noopener noreferrer" target="_blank">
                          <i class="fa fa-medium fa-3x"></i>
                        </a>
                        <a href="https://github.com/DataBrokerDAO" rel="nofollow noopener noreferrer" target="_blank">
